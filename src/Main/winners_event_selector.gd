...
func _on_back_pressed() -> void:
	var Dashboard:PackedScene = load("res://src/Main/winners_club_selector.tscn")
...
func _on_event_button_pressed() -> void:
	var winners:PackedScene = load("res://src/Main/winners.tscn")
	get_tree().change_scene_to_packed(winners)
